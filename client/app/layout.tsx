...
const pluginsidebar : string = 'E:/BTL-Pharmacy/pharmacy/client/Plugin/sidebar'; // Đường dẫn đến thư mục chứa các plugin
const pluginrightbar : string = 'E:/BTL-Pharmacy/pharmacy/client/Plugin/rightbar'; // Đường dẫn đến thư mục chứa các plugin
